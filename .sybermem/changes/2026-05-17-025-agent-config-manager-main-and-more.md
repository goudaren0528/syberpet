...
status: implemented
author: wane528
related_files: agent-config.json, agent/conversation/manager.ts, electron/main.ts, renderer/App.tsx, renderer/store/state.ts, renderer/ui/InputBar.tsx, docs/superpowers/specs/2026-05-17-experience-skeleton-design.md
---
