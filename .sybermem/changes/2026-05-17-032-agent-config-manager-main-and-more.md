...
status: implemented
author: wane528
related_files: agent-config.json, agent/conversation/manager.ts, electron/main.ts, renderer/store/state.ts, renderer/ui/InputBar.tsx, renderer/pet/interactionRewards.ts
---
